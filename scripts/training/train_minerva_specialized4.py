...
def train_strategic_stage(model, dataloader, criterion, optimizer, scheduler, scaler, 
    ...
    for epoch in range(epochs_for_stage):
        ...
        # Progress bar
        pbar = tqdm(dataloader, desc=f"\033[96mStrategic Stage {stage_idx} Epoch {epoch}\033[0m")
        ...
        if epoch % 5 == 0 or epoch == epochs_for_stage - 1:
            ...
            print(f"\033[96mStrategic Stage {stage_idx} Epoch {epoch}: "
                  f"Performance = {epoch_performance:.1%}, "
                  f"Strategic Cases = {strategic_ratio:.1%}, "
