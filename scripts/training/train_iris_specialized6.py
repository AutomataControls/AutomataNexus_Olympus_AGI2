...
# Import IRIS V6 enhanced model
from src.models.iris_v6_enhanced import IrisV6Enhanced

# Enhanced IRIS V6 Configuration
IRIS_V6_CONFIG = {
    'batch_size': 48,
...
def train_iris_specialized_v6():
    ...
    print(f"\033[96mInitializing IRIS V6 Intelligent Color Intelligence Training...\033[0m")
