"""
IRIS Individual Training Script
Color Pattern Recognition Expert Training
"""
...
def train_iris():
    """Train IRIS model with curriculum learning"""
    print("\n" + "="*60)
    print("👁️ Training IRIS - Color Pattern Recognition Expert")
    print("="*60)
    
    # Create model
    model = EnhancedIrisNet().to(device)
    ...
    print(f"✅ Report saved to: /content/AutomataNexus_Olympus_AGI2/src/models/reports/iris/")
...
if __name__ == "__main__":
    print("="*80)
    print("IRIS - Color Pattern Recognition Expert Training")
    print("="*80)
